...
def generate_link():
    ...
    try:
        ...
        # Store in admin data
        admin_data[admin_id] = admin_data.get(admin_id, {'links': [], 'bot_tokens': []})
        ...
        flash('Error generating link. Please try again.', 'error')
        return redirect(url_for('home'))
...
def send_messages(link_id):
    ...
    try:
        ...
        if link_data.get('used'):
            return render_template('link_expired_simple.html', message="This link has been used!")
        ...
        return render_template('link_expired_simple.html', message="An error occurred while processing your request.")
...
def admin_login_submit():
    ...
    try:
        ...
        print(f"Admin login submit error: {e}")
...
def admin_dashboard():
    ...
    try:
        ...
        stats = {'total_links': 0, 'total_used_links': 0, 'total_messages': 0, 'active_admins': 0}
        safe_admin_data = {}
...
def debug_sample_data():
    """Create sample data for testing (GET only)"""
